...
<div class="row">
    <div class="main-home_one-col main-home_inset main-home_inset_to_<?php echo $layout_class ?> featured-text">
        <h3 class="heading heading-tagline"><?php the_title(); ?></h3>
        <a class="seemore" href="<?php echo esc_url( $category_link ); ?>">See More</a>
    </div>
    <div class="main-home_one-col main-home_inset main-home_inset_<?php echo $layout_class ?>">
